...
- Keep the project as a single Rust binary for now.
...
| 2026-03-07 | Keep a built-in API catalog in `src/catalog.rs` | Avoids runtime scraping and gives the CLI self-description |
